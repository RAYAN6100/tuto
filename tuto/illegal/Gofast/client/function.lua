...
spawnCar = function(car)
    ...
    local vehicle = CreateVehicle(car,  7767.88293457031,-1899.8696289063,28.759674072266, 263.71, true, false)
...
Citizen.CreateThread(function()
    ...
    local npc2 = CreatePed("PED_TYPE_CIVMALE", "s_m_m_bouncer_01", 765.951, -1895.5782,  28.27, 100.40, false, true)
